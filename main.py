...
from plotting import plot_best_cost_progress, plot_cities_and_tour, plot_salaries
...
def main():
    ...
    #plot_cities_and_tour(salesman.cities,salesman.optimal_route)
    #plot_best_cost_progress(temperature_progress, average_time_cost,  squared_best_cost, dif_parameters,plot_average=False, C_func = True)
